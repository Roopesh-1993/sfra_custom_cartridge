...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            address:registrationForm.customer.address.value //custom attribute created
        };
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.custom.address = registrationForm.address; //newly created custom attribute
                            }
                        });
                    } catch (e) {
                        if (e.authError) {
